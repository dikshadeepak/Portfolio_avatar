...
import heroVideo from '../assets/hero video/diksha_hero.mp4';
...
<div className="hidden lg:flex fixed left-2 top-2 z-50">
  <div className="w-24 h-24 rounded-full overflow-hidden border border-white/20 bg-black/20 backdrop-blur-md shadow-[0_0_30px_rgba(255,255,255,0.2)]">
    <img
      src="/newfav.png"
      alt="Logo"
