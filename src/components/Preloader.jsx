    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#050816] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div
          ...
          >
            ...
            <motion.div
              className="absolute top-0 left-0 text-[#ff2a2a] overflow-hidden whitespace-nowrap"
