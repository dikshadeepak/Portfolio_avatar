...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      <path fill="#3776AB" d="M63.9 0C31.7 0 33.7 14 33.7 14v14.5h30.6v4.8H21.5S0 31.1 0 63.8c0 32.7 18.8 31.6 18.8 31.6h11.2V79.9s-.6-18.8 18.5-18.8h31.9s17.9.3 17.9-17.3V17.6S100.7 0 63.9 0zm-16.8 10.5a5.7 5.7 0 110 11.4 5.7 5.7 0 010-11.4z"/>
      <path fill="#FFD43B" d="M64.1 128c32.2 0 30.2-14 30.2-14V99.5H63.7v-4.8h42.8S128 96.9 128 64.2c0-32.7-18.8-31.6-18.8-31.6H98v15.5s.6 18.8-18.5 18.8H47.6S29.7 66.6 29.7 84.2v26.2S27.3 128 64.1 128zm16.8-10.5a5.7 5.7 0 110-11.4 5.7 5.7 0 010 11.4z"/>
    </svg>
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Diksha Deepak — Full Stack & Python Developer" 
